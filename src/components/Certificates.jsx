...
import Certificate16 from "../assets/img/Certificate16.png";
    ...
    return (
        <>
            ...
            <div className="certificates-wrapper">
                ...
                <div className="row my-4">
                    <div className="col certificates-ratio">
                        <img className="shadow" loading="lazy" src={Certificate16} alt="Certificate 16" onClick={() => openLightboxOnSlide(16)} />
                    </div>
                </div>
            </div>
        </>
